...
% fprintf(' %-23s %12.0f\n',    'Total desaturation events (2 yr)',      N_desat);
% fprintf(' %-23s %12.2f kg\n', 'Required propellant mass',              M_prop);
...
fprintf(' %-23s %13s %12.2f %6s\n', 'Tot. Thruster slew time', "-", t_slew_thr, "s");
fprintf('\n');
