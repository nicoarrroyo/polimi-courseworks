...
A_cell      = 27.6e-4;  % Cell area                 [m^2] TODO https://ui.adsabs.harvard.edu/scan/manifest/2002ESASP.502..305P
V_cell      = 0.60;     % Cell max-power voltage    [V] https://ocw.tudelft.nl/wp-content/uploads/solar_energy_section_15_1-15_3.pdf
V_bus       = 60;       % SA voltage                [V] TODO
packing_sa  = 0.15;     % Packing factor for SAs    [-] TODO
...
C_batt      = N_parallel_b * pack_batt * C_cell;   % [Ah] per pack

fprintf(' Cell configuration (Li-Ion: %.1f Ah, %.1f V; packing eff. %.2f):\n', ...
    C_cell, V_cell_l, pack_batt);
